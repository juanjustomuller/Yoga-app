        ...
        {classes.map((cls, index) => (
          ...
          >
            <div className="relative h-48">
              ...
              >
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button className="px-4 py-2 text-white disabled:bg-red-300 bg-secondary duration-300 rounded hover:bg-red-600">Add to Cart</button>
                  </div>
              </Transition>
            </div>
            ...
            <div className="px-6 py-2">
              ...
              <p className="text-gray-500 text-x5">Instructor: {cls.instructorName}</p>
