                    ...
                    <div key={index} className='flex dark:text-white hover:-translate-y-2 duration-200 cursor-pointer flex-col shadow-md py-8 px-10 md:px-8 rounded-md'>
                        <div className='flex-col flex gap-6 md:gap-8'>
                            ...
                            <div className='flex flex-col text-center'>
                                <p className='font-medium text-lg dark:text-white text-gay-800'>{instructor?.instructor?.name}</p>
                                <p className='text-gray-500 whitespace-nowrap'>Instructor</p>
                                <p className='text-gay-500 mb-4 whitespace-nowrap'>Total Students: {instructor?.totalEnrolled}</p>
                            </div>
                        </div>
                    </div>
                ))
